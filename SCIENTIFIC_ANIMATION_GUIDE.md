# 科学/教育通用动画设计指南 (Scientific Animation Guidelines)

本指南旨在总结适用于科学解释、技术演示及教育类视频的动画设计原则。不同于娱乐动画，此类动画的核心目标是**准确性 (Accuracy)**、**清晰度 (Clarity)** 和 **逻辑连贯性 (Coherence)**。

## 1. 核心原则 (Core Principles)

### 1.1 拒绝“果冻效应” (No Jelly Effect)
...
### 1.2 上下文持久性 (Context Persistence)
...
## 2. 场景布局规范 (Layout Standards)

### 2.1 左右流式布局 (Left-to-Right Flow)
*   **适用**：推导过程、数据转换、因果关系。
*   **结构**：
...
### 2.2 坐标系与数学空间 (Coordinate Systems)
*   **原点位置**：
    *   不要默认居中，应根据数据分布调整。
...
### 3.3 连贯转场 (Coherent Transitions)
*   **变换 (Transform)** 优于 **替换 (Replace)**。
*   **示例**：
    *   好：原本是“圆点”的人，变形伸展成为“条形图”。
    *   差：人消失，原位突然出现条形图。

## 4. 技术实现检查清单 (Technical Checklist)
